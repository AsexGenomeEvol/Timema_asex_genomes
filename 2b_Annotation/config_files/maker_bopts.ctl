...
depth_blastn=10 #Blastn depth cutoff (0 to disable cutoff)
...
depth_blastx=10 #Blastx depth cutoff (0 to disable cutoff)
...
depth_tblastx=10 #tBlastx depth cutoff (0 to disable cutoff)
