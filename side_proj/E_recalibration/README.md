...
and then readjust their values in the **bam** files. This process is accomplished by analyzing the covariation among several features of a base, mainly its *reported quality score*, its *position* within the read and the effect of preceding and current nucleotide (aka *sequencing chemistry effect*).
