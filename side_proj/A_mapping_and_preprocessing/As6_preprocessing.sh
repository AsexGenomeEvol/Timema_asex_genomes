...
cp /archive/dee/schwander/ptranvan/mites/assembly/spades/without_conta/as6/round3/sspace/127/Gapcloser/bwa/As6.trim.{180,350,550}.pair12.sam .
...
sort_and_assign_RG As6 180 r1 &
sort_and_assign_RG As6 350 r2 &
sort_and_assign_RG As6 550 r3 &

wait

rm As6.trim.{180,350,550}.pair12.sam
samtools merge ref_to_2_As_b1v01.bam As6.trim.{180,350,550}.pair12.sort.RG.sam
...
atlas task=estimateTheta \
    ...
    As6.trim.{180,350,550}.pair12.sam
